    ...
    $('#team-container').html(Mustache.render(
        ...
        {member: [
            {name:'ד"ר הלית מעיין', role:'ממשקים', slug: 'hilit',
             ...
             profile: '<p>הילית מומחית בפיתוח חוויית משתמש ובעלת ניסיון רב שנים בהובלת תהליכי תכנון ועיצוב מערכות דיגיטליות מורכבות. בעלת רקע עשיר בהנדסת אנוש ופסיכולוגיה קוגניטיבית משולבת בגישת "הנדס און" – גישה המעודדת מעורבות משתמש פעילה. ייסדה, ניהלה והובילה צוותי עיצוב ופיתוח מוצר בחברות Trax, Retalix, Intel ועוד. הלית משמשת כמנטורית חוויית משתמש ומוצר בגוגל.</p>' 
            },
